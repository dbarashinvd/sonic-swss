...
bool OrchDaemon::init()
{
    ...
    TableConnector stateDbTxErrMon(m_stateDb, STATE_TX_ERR_MON_TABLE_NAME);
    TableConnector confDbTxErrMon(m_configDb, CFG_TX_ERR_MON_TABLE_NAME);
    TableConnector appDbTxErrMon(m_applDb, APP_TX_ERR_MON_TABLE_NAME);
    gTxErrMonOrch = new TxErrMonOrch(stateDbTxErrMon, confDbTxErrMon, appDbTxErrMon);
     ...
     */
    m_orchList = { gSwitchOrch, gCrmOrch, gPortsOrch, gBufferOrch, mux_orch, mux_cb_orch, gIntfsOrch, gNeighOrch, gNhgMapOrch, gNhgOrch, gCbfNhgOrch, gRouteOrch, gCoppOrch, gQosOrch, wm_orch, policer_orch, tunnel_decap_orch, sflow_orch, debug_counter_orch, gMacsecOrch, gBfdOrch, gSrv6Orch, gTxErrMonOrch};
